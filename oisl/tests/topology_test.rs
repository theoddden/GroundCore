...
mod tests {
    ...
    fn test_graph_snapshot_creation() {
        ...
        let node_state = NodeState {
            ...
            position: Position3D { x_km: 0.0, y_km: 0.0, z_km: 7000.0 },
            velocity: Velocity3D { x_km_s: 7.5, y_km_s: 0.0, z_km_s: 0.0 },
        };
    ...
    fn test_position_3d_distance() {
        let pos1 = Position3D { x_km: 0.0, y_km: 0.0, z_km: 0.0 };
        let pos2 = Position3D { x_km: 3.0, y_km: 4.0, z_km: 0.0 };
